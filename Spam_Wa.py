#!/usr/bin/python
# Halo Gw ARYA X-PLOIT Gw Udah Buat Script Premium Wa Yang Bisa Di Decode >_<
# KUY LANJUT
...
def apakah():
	while True:
		...
		if( lan == 'y' or lan == 'Y'):
			...
			print ('JANGAN LUPA SUBS ARYA X-PLOIT')
			time.sleep(4)
...
def dark():
        ...
        print ('')
def dark_exit():
	print (C+'BYE.. JANGAN LUPA SUBSCRIBE CHANNEL ARYA X-PLOIT')
	os.system('exit')
def jnspam():
	global jns
	dark_format_0992()
